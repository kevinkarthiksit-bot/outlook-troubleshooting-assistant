...
const scripts = [
  ...
  "js/troubleshooting-search.js", "js/step-utils.js", "js/kb-loader.js", "js/search.js",
  "js/admin.js"
];
...
try {
  const kb = JSON.parse(fs.readFileSync(path.join(root, "data/kb-articles.sample.json"), "utf8"));
